              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (_userRole == 'admin')
                      ListTile(
                        leading: Icon(Icons.location_city, color: _abaSelecionada == 3 ? Colors.cyanAccent : Colors.grey),
                        title: Text(
                          'Planos por cidade',
                          style: TextStyle(color: _abaSelecionada == 3 ? Colors.white : Colors.grey, fontWeight: FontWeight.bold),
                        ),
